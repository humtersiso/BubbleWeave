# BubbleWeave（織泡劇場）── 產品需求說明書 (PRD) · **v1 凍結**

> **版本**：v1.0-stable（2026-07-23／24 凍結）  
> **Git tag**：`v1.0-stable`  
> **狀態**：**定案凍結** — 大改請改 [`PRD_v2.md`](./PRD_v2.md)，勿再大幅改本檔  
> **相關文件**：[`CHARACTER_BIBLE.md`](./CHARACTER_BIBLE.md) · [`CHARACTER_COMBOS.md`](./CHARACTER_COMBOS.md) · [`README.md`](../README.md)  
> **程式**：Vite + React 18 + Tailwind；本機 Demo（IndexedDB `bubbleweave`，v1）
